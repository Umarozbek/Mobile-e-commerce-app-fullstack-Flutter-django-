...
class CategoryAdmin(TranslationAdmin):  # Tarjimalar bilan
    list_display = ("preview", "name", "main_type", "active", "is_top", "created")
    list_filter = ("main_type", "active", "is_top")
    list_editable = ("active", "is_top")
    search_fields = ("name",)
...
class ProductItemAdmin(TranslationAdmin):
    ...
    search_fields = ["name", "desc", "product_type", "goods__name", "phones__model_name"]
...
class GoodAdmin(TranslationAdmin):
    list_display = ["id", "name", "category", "expire_date"]
...
class ImageAdmin(TranslationAdmin):
    ...
    search_fields = ["name", "product__id", "product__desc"]
